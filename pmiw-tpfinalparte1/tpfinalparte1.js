...
function mousePressed() {
  //INICIO
  if (mouseX >= BotonInicio.x && mouseX <= BotonInicio.x + BotonInicio.w &&
  ...
  //SIG
  if (mouseX >= BotonSiguiente.x && mouseX <= BotonSiguiente.x + BotonSiguiente.w &&
      mouseY >= BotonSiguiente.y && mouseY <= BotonSiguiente.y + BotonSiguiente.h) {
    estado += BotonSiguiente.cambio;
    console.log("Pasaste al estado: " + estado);
  }

//SI
  if (mouseX >= BotonSi.x && mouseX <= BotonSi.x + BotonSi.w &&
  ...
  //NO
  if (mouseX >= BotonNo.x && mouseX <= BotonNo.x + BotonNo.w &&
